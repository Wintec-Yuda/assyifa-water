...
export const products: ProductCategory[] = [
  ...
  },
  {
    id: "aqua-botol",
    name: "Aqua Botol",
    description: "Tersedia ukuran 330ml, 600ml, dan 1500ml. Bisa beli per dus untuk acara/kantor.",
    unit: "per dus",
    retailPrice: "Mulai Rp38.000",
    wholesalePrice: "Rp35.000 - Harga khusus untuk pembelian partai",
    imageAlt: "Aqua botol berbagai ukuran",
  },
  {
    id: "aqua-gelas",
    name: "Aqua Gelas",
    description: "Kemasan gelas 240ml per dus. Cocok untuk konsumsi harian atau acara.",
    unit: "per dus",
    retailPrice: "Rp20.000",
    wholesalePrice: "Rp18.000 - Harga khusus untuk pembelian partai",
    imageAlt: "Aqua gelas kemasan cup",
  },
  {
    id: "club-botolan",
    name: "Club Botolan & Gelas",
    description: "Tersedia varian botol dan gelas Club sebagai alternatif merek.",
    unit: "per dus",
    retailPrice: "Mulai Rp17.000",
    wholesalePrice: "Rp15.000 - Harga khusus untuk pembelian partai",
    imageAlt: "Club air minum kemasan botol dan gelas",
  },
];
